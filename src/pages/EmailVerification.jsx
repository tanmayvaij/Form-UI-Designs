    ...
    >
      <div className="border bg-white rounded-md shadow-md flex items-center justify-center flex-col space-y-8 px-10 py-10">
        ...
        <div className="text-center text-gray-700 max-w-lg">
          <p>
            You have entered{" "}
            <span className="text-blue-600">tanmayvaij22@gmail.com</span> as the
            email address for your account.
          </p>
          <p>Please verify this email address by clicking below button.</p>
        </div>
        ...
        <div className="text-center text-gray-700 ">
          ...
          <Link className="text-xs text-blue-500 hover:underline">
            https://www.ukcompany.com/verifyemail?=tanmayvaij22%40gmail.com
          </Link>
        </div>
      </div>
    </div>
