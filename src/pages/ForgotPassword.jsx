...
export default function ForgotPassword() {
    return (
        <div id="forgotpassword" className="min-h-screen flex items-center justify-center">
            <div className="border bg-white rounded-md shadow-md flex items-center justify-center flex-col space-y-8 px-10 py-10">
                ...
                <p className="text-sm">
                    <Link className="pl-4 underline text-blue-400 hover:text-blue-600" to="/"> &lt; Back to Login</Link>
                </p>
